...
<div class="pp-main">
    ...
    <div style="display:flex;gap:20px;flex-wrap:wrap;margin-top:12px;">
        <?php $__currentLoopData = ['#E1306C' => 'Instagram', '#27AE60' => 'Published', '#C0392B' => 'Failed', 'rgba(255,107,0,0.5)' => 'Festival']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $color => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div style="display:flex;align-items:center;gap:6px;font-size:12px;color:#666;">
                <span style="width:10px;height:10px;border-radius:50%;background:<?php echo e($color); ?>;display:inline-block;"></span>
                <?php echo e($label); ?>
        ...
        <div class="pp-drawer-body">
            ...
            <?php if($accounts->isEmpty()): ?>
                <div style="background:rgba(255,107,0,0.08);border:1px solid rgba(255,107,0,0.2);border-radius:10px;padding:12px;font-size:12px;color:#888;margin-bottom:16px;">
                    No accounts connected. Go to <a href="<?php echo e(route('dashboard.accounts')); ?>" style="color:#FF6B00;">Accounts</a> to connect Instagram.
                </div>
            <?php else: ?>
                <div style="display:flex;gap:8px;flex-wrap:wrap;margin-bottom:16px;" id="accountsList">
                    <?php $__currentLoopData = $accounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div id="acc-<?php echo e($account->id); ?>" onclick="toggleAccount(<?php echo e($account->id); ?>)"
                            ...
                            <?php if($account->profile_picture_url): ?>
                                <img src="<?php echo e($account->profile_picture_url); ?>" style="width:20px;height:20px;border-radius:50%;" alt="">
                            <?php endif; ?>
            ...
            <div id="aiBox" style="background:#080810;border:1px solid #18182A;border-radius:12px;padding:16px;margin-bottom:16px;">
                ...
                <div style="display:flex;gap:8px;margin-bottom:14px;flex-wrap:wrap;">
                    <?php $__currentLoopData = ['friendly','professional','exciting','urgent']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <button type="button" class="tone-btn" data-tone="<?php echo e($t); ?>" onclick="setTone('<?php echo e($t); ?>')"
...
<script>
const FESTIVALS_URL = '<?php echo e(route("festivals")); ?>';
const GENERATE_URL  = '<?php echo e(route("generate")); ?>';
const CALENDAR_URL  = '<?php echo e(route("api.calendar")); ?>';
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    <?php if($accounts->isNotEmpty()): ?>
        toggleAccount(<?php echo e($accounts->first()->id); ?>);
    <?php endif; ?>
...
async function submitPost() {
    ...
    try {
        ...
        const res  = await fetch('<?php echo e(route("posts.store")); ?>', { method: 'POST', body: formData });
        ...
        if (res.ok) {
            ...
            window.location.href = '<?php echo e(route("dashboard.pricing")); ?>';
        } else {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\postpilot-laravel\resources\views/dashboard/calendar.blade.php ENDPATH**/ ?>