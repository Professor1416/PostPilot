...
<body>
    <div class="card">
        ...
        <div class="features">
            @foreach(['Schedule Instagram posts automatically', 'AI writes captions in Hindi, English, Hinglish', 'Indian festival calendar pre-loaded', 'Start free — 5 posts, no credit card needed'] as $f)
                <div class="feature"><span class="check">✓</span><span>{{ $f }}</span></div>
            @endforeach
        </div>
        ...
        <a href="{{ route('auth.google') }}" class="login-btn">
